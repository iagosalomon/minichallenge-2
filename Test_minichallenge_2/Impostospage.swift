...
class Impostospage: UIViewController {
    ...
    let impostosindiretosoqueeh = ["É um imposto que você paga em cada operação financeira à crédito. Esse imposto é calculado através de uma alíquota que pode variar de banco para banco. Normalmente os bancos digitais tendem a cobrar mais caro o IOF do que os bancos físicos.",
